                ...
                <div className="content px-5">
                    ...
                    <div className="add-company mt-4 p-4">
                        <div className="d-flex">
                            <div className="my-info-1">
                                <div className='mx-4'>
                                    ...
                                    <input type="text" class="form-control add-company-input" placeholder="SL louis" aria-label="" aria-describedby="basic-addon1"></input>
                                </div>
                                <div className='mx-4'>
                                    <h5 className='my-3'>Country</h5>
                                    <input type="text" class="form-control add-company-input" placeholder="United States" aria-label="" aria-describedby="basic-addon1"></input>
                                </div>
                                <div className='mx-4'>
                                    <h5 className='my-3'>State / Province</h5>
                                    <input type="text" class="form-control add-company-input" placeholder="Missouri" aria-label="" aria-describedby="basic-addon1"></input>
                                </div>
                                <div className='mx-4'>
                                    <h5 className='my-3'>Postal Code</h5>
                                    <input type="text" class="form-control add-company-input" placeholder="63101" aria-label="" aria-describedby="basic-addon1"></input>
                                </div>
                            </div>
                            <div >
                                <div className="my-info-2">
                                    <div className='mx-4'>
                                        <h5 className='my-3'>Business Address</h5>
                                        <input type="text" class="form-control add-company-input" placeholder="" aria-label="" aria-describedby="basic-addon1"></input>
                                    </div>
                                    <div className='mx-4'>
                                        <h5 className='my-3'>Address<span className='add-company-span'> line 2</span></h5>
                                        <input type="text" class="form-control add-company-input" placeholder="" aria-label="" aria-describedby="basic-addon1"></input>
                                    </div>
                                    <div className='mx-4'>
                                        <h5 className='my-3'>Address<span className='add-company-span'> line 3</span></h5>
                                        <input type="text" class="form-control add-company-input" placeholder="" aria-label="" aria-describedby="basic-addon1"></input>
                                    </div>
                                </div>
                                ...
                                <div className='mx-4 my-2 text-end'>
                                    <button className='add-company-button-1'>Update</button>
                                    <button className='my-info-button'>Close</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className='mx-4 my-2'>
                            <h4 style={{ color: '#515151' }}>Note</h4>
                            <p style={{ color: '#ACACB0' }}>Adding a company could have a slight delay in processing while your company information is validated. You can continue to use the site but you cannot file until your company information has been validated.</p>
                        </div>
                    </div>
