            ...
            <div className="d-flex">
                ...
                <div className="content px-5">
                    ...
                    <div className='Company-header-3'>
                        <Link to={'/mycompany-employee'} style={{ textDecoration: 'none', color: "black" }} className='Company-header-4 ps-3 py-2'>General Information</Link>
                        <Link to={'/mycompany-employee-members'} style={{ textDecoration: 'none', color: "white" }} className='Company-header2 py-2 ps-4'>Company Members</Link>
                    ...
                    <div className='my-companies-sec-2 pt-4 px-5'>
                        <div className="d-flex justify-content-between">
                            <h5 className='me-4' style={{ width: "210px" }}>Name</h5>
                            <h5 className='ms-4' style={{ width: "832px" }}>Company Type</h5>
                        ...
                        <Link to={'/mycompany-employee'} className="d-flex justify-content-between pt-2" style={{ cursor: 'pointer', textDecoration: 'none', color: 'black' }}>
                            ...
                            <p style={{ width: "832px" }}>89-8655452</p>
                        </Link>
                        <Link to={'/mycompany-employee'} className="d-flex justify-content-between pt-2" style={{ cursor: 'pointer', textDecoration: 'none', color: 'black' }}>
                            <p className='me-4' style={{ width: "218px" }}>Formation Year</p>
                            <p style={{ width: "832px" }}>1970</p>
                        </Link>
                        <Link to={'/mycompany-employee'} className="d-flex justify-content-between pt-2" style={{ cursor: 'pointer', textDecoration: 'none', color: 'black' }}>
                            <p className='me-4' style={{ width: "218px" }}>Address 1</p>
                            <p style={{ width: "832px" }}>122 - Trucking Way</p>
                        </Link>
                        <Link to={'/mycompany-employee'} className="d-flex justify-content-between pt-2" style={{ cursor: 'pointer', textDecoration: 'none', color: 'black' }}>
                            <p className='me-2' style={{ width: "233px" }}>Address 2</p>
                            <p style={{ width: "832px" }}></p>
                        </Link>
                        <Link to={'/mycompany-employee'} className="d-flex justify-content-between pt-2" style={{ cursor: 'pointer', textDecoration: 'none', color: 'black' }}>
                            <p className='' style={{ width: "243px" }}>Address 3</p>
                            <p style={{ width: "832px" }}></p>
                        </Link>
                        <Link to={'/mycompany-employee'} className="d-flex justify-content-between pt-2" style={{ cursor: 'pointer', textDecoration: 'none', color: 'black' }}>
                            <p className='' style={{ width: "243px" }}>City</p>
                            <p style={{ width: "832px" }}>Alianta</p>
                        </Link>
                        <Link to={'/mycompany-employee'} className="d-flex justify-content-between pt-2" style={{ cursor: 'pointer', textDecoration: 'none', color: 'black' }}>
                            <p className='' style={{ width: "243px" }}>State / Province</p>
                            <p style={{ width: "832px" }}>Georgia</p>
                        </Link>
                        <Link to={'/mycompany-employee'} className="d-flex justify-content-between pt-2" style={{ cursor: 'pointer', textDecoration: 'none', color: 'black' }}>
                            <p className='' style={{ width: "243px" }}>Country</p>
                            <p style={{ width: "832px" }}>United States</p>
                        </Link>
                    </div>
...
export default Mycompanyemployee
